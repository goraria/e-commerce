...
const ProductConfigurations = require('../models/ProductConfigurations')
...
class AdminController {
    ...
    async updateCategory(req, res) {
        ...
        const updated = req.body; // Dữ liệu cập nhật
        ...
        try {
            ...
            await category.update(updated); // Cập nhật dữ liệu từ client
