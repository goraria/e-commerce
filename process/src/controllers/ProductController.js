const Product = require('../models/old/Product');
const Description = require('../models/old/Description');
const Configuration = require('../models/old/Configuration')
const Accessory = require("../models/old/Accessory")
const Rating = require("../models/old/Rating")
const Color = require("../models/old/Color")
const Category = require("../models/old/Category")
const Account = require("../models/old/Account")
const User = require("../models/old/User")
const BillDetail = require("../models/old/BillDetail")
const CartItem = require("../models/old/CartItem")
