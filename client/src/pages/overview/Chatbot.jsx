                    ...
                    <div className="app-chat card overflow-hidden">
                        <div className="row g-0">
                            ...
                            <div
                                ...
                                <button className="btn btn-primary app-chat-conversation-btn"
                  ...
                  <i className="icon-base bx bx-search icon-md"></i>
                                                ...
                                                <div className="dropdown">
                                                    <button
                                                        ...
                                                        className="icon-base bx bx-dots-vertical-rounded icon-md"></i>
                                                    </button>
                                                    <div className="dropdown-menu dropdown-menu-end"
                                                         aria-labelledby="chat-header-actions">
                                                        <a className="dropdown-item" >View
                                                            Contact</a>
                                                        <a className="dropdown-item" >Mute
                                                            Notifications</a>
                                                        <a className="dropdown-item" >Block
                                                            Contact</a>
                                                        <a className="dropdown-item" >Clear
                                                            Chat</a>
                                        ...
                                        <ul className="list-unstyled chat-history">
                                            ...
                                            <li className="chat-message chat-message-right">
                                                <div className="d-flex overflow-hidden">
                                                    <div className="chat-message-wrapper flex-grow-1">
                                                        <div className="chat-message-text">
                                                            <p className="mb-0">Sneat has all the components you&#39;ll ever
                                                                need in a app.</p>
                                                        </div>
                                                        <div className="text-end text-body-secondary mt-1">
                                                            <i className="icon-base bx bx-check-double icon-16px text-success me-1"></i>
                                    ...
                                    <div className="chat-history-footer shadow-xs">
                                        <form
                                            ...
                                            <input className="form-control message-input border-0 me-4 shadow-none"
                    ...
                    <div className="container-xxl">
                        <div
                            ...
                            <div className="mb-2 mb-md-0">
                                ...
                                </script>2025, made with ❤️ by <a href="https://themeselection.com" target="_blank"
                                                                  className="footer-link">ThemeSelection</a>
                            </div>
                            <div className="d-none d-lg-inline-block">
                                ...
                                <a href="https://themeselection.com/support/" target="_blank"
                                   className="footer-link d-none d-sm-inline-block">Support</a>
